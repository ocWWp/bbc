...
**Phase Goal:** BBC repo at `/Users/grid/Documents/GitHub/bbc/` is 100% free of 8azi-specific content; 8azi-specific content lives at `/Users/grid/Documents/GitHub/8azi-bbc-tenant/` (local-only, git-init'd); BBC ships with 7 generic role-named provider adapters, a runnable Acme Co demo, an architecture doc, and dashboard defaults that work out-of-box against the demo.
...
| `8azi-bbc-tenant/.git/` + 1 commit                                        | git on `main`     | ✓ VERIFIED | Commit `a71b552`, branch `main`.                                          |
