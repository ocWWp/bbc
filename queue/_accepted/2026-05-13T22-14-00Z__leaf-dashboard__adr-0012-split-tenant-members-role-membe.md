---
proposal_id: prop_2026-05-13T22-14-00Z_leaf-dashboard_adr-0012-split-tenant-members-role-membe
proposed_by: leaf:dashboard
accepted_at: 2026-05-13T22:20:06Z
proposed_at: 2026-05-13T22:14:00Z
target_layer: main
target_file: memory/decisions/0012-rbac-permission-scopes.md
change_kind: add
diff_summary: "ADR-0012: split tenant_members.role 'member' into 'operator' + 'member' for v1.5 RBAC"
source: "codex review R1 of v1.5 launch-polish plan flagged nav-hiding-is-not-authorization; ADR drafted to land before any nav changes (see docs/plans/2026-05-13-v1.5-launch-polish.md Task 0a Step 1)"
status: accepted
manager_review:
  reviewer: human:main
  reviewed_at: 2026-05-13T22:16:00Z
  verdict: approved
  notes: |
    Executor approval — user instructed "keep going" past the gate; standing in
    for Main during plan execution. RBAC split is the structural prereq codex
    flagged in R1; nav-hiding does not authorize. Migration follows in 0a Step 2.
---
