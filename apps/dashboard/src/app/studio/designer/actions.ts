 ...
 * entries, UI copy passes. Same shape as Founder/Engineering Studios: no LLM
 * router, no override flow yet. template_id is namespaced "design:*"; runs
 * share the `studio_runs` table.
 */
