...
export const SKILLS: SkillItem[] = [
  ...
  { id: "sk_008", kind: "skill", role: "sales",       name: "Discovery-call notes", author: "community",       desc: "Listens to call transcript, extracts pain / budget / timing / champion. Files vendor + note rows.", reads: ["voice", "glossary"], writes: ["vendor", "note"], installed: false, recommended: false, badge: null, stars: 88, updated: "2026-04-02", license: "Apache-2.0", repo: "github.com/bbc-org/skills/sales-discovery", glyph: "$" },
  ...
  { id: "sk_011", kind: "skill", role: "designer",    name: "Empty-state copy pass", author: "community",   desc: "Generates copy for empty / loading / error states honoring don't-use list.", reads: ["voice", "product"], writes: ["note"], installed: false, recommended: false, badge: null, stars: 67, updated: "2026-04-25", license: "MIT", repo: "github.com/bbc-org/skills/designer-empty-state", glyph: "D" },
