...
export const FOLDER_ANNOTATIONS: Record<string, string> = {
  ...
  "distribution/<<tenant-app-web>>": "frontend leaf (migrated in M1)",
  ...
  "memory/glossary": "canonical terms (<your-tenant-voice>, Nayin, Diagnose, …)",
  ...
  "memory/skills/<your-app-leaf>": "F2 web-leaf specializations",
  "memory/skills/<your-api-leaf>": "F2 api-leaf specializations",
